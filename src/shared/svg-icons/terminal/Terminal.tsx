...
const Terminal = ({ className }: SVGProps): JSX.Element => {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none">
      ...
      <path d="M35 16H41C43.2091 16 45 17.7909 45 20V67C45 69.2091 43.2091 71 41 71H13C10.7909 71 9 69.2091 9 67V20C9 17.7909 10.7909 16 13 16H19V16" stroke="black" stroke-width="2"/>
      <path d="M45 21H47C48.1046 21 49 21.8954 49 23V51C49 52.1046 48.1046 53 47 53H45V21Z" stroke="black" stroke-width="2"/>
      <path d="M49 24H68C69.6569 24 71 25.3431 71 27V47C71 48.6569 69.6569 50 68 50H49V24Z" stroke="black" stroke-width="2"/>
